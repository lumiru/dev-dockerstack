...
echo "percona-server-server-5.6 percona-server-server/root_password password $DEFAULT_ROOT_PASSWORD" | debconf-set-selections
echo "percona-server-server-5.6 percona-server-server/root_password_again password $DEFAULT_ROOT_PASSWORD" | debconf-set-selections
